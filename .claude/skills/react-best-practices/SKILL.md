...
description: >-
  React performance optimization guidelines (Vercel). Use when writing, reviewing,
  or refactoring React code for optimal performance. Triggers on tasks involving
  React components, data fetching, bundle optimization, or performance improvements.
---

# React Best Practices

Comprehensive performance optimization guide for React applications. Contains 54 rules across 7 categories, prioritized by impact to guide automated refactoring and code generation.

Based on [Vercel's React Best Practices](https://github.com/vercel/agent-skills).
...
Adapted from [Vercel Agent Skills](https://github.com/vercel/agent-skills) (MIT License).
